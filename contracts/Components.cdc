access(all) contract Components {
    ...
    access(all) struct Accessories: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "accessories_".concat(self.name))!)
    ...
    access(all) struct Clothing: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "clothing_".concat(self.name))!)
    ...
    access(all) struct ClothingGraphic: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "clothingGraphic_".concat(self.name))!)
                ?? panic("clothing not found")
            return content[0]
        }
    ...
    access(all) struct Eyebrows: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "eyebrows_".concat(self.name))!)
    ...
    access(all) struct Eyes: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "eyes_".concat(self.name))!)
    ...
    access(all) struct FacialHair: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "facialHair_".concat(self.name))!)
    ...
    access(all) struct Mouth: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "mouth_".concat(self.name))!)
    ...
    access(all) struct Nose: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "nose_".concat(self.name))!)
    ...
    access(all) struct Style: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "style_".concat(self.name))!)
    ...
    access(all) struct Top: Component {
        ...
        access(all) fun build(components: {String: {Component}}, colors: Colors): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "top_".concat(self.name))!)
                ?? panic("top not found")
    ...
    access(all) struct Renderer {
        ...
        access(all) fun build(): String {
            let content = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "base_".concat("default"))!)
                ?? panic("base not found")
            
            let document = Components.account.capabilities.borrow<&[String]>(PublicPath(identifier: "document_default")!)
    ...
    access(all) resource Admin {
        access(all) let options: {String: {String: Bool}}
        access(all) let colors: {String: Bool}

        access(all) fun createRandom(): Renderer {
            let c: [String] = []
            var count = 0
            while count < 7 {
                count = count + 1
        ...
        access(all) fun registerContent(component: String, name: String, content: [String]) {
        ...
        access(all) fun addColor(_ c: String) {
            self.colors.insert(key: c, true)
        }

        access(all) fun removeColor(_ c: String) {
